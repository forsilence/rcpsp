...
int main(int argc,char *argv[])
{
    ...
    if(argc>1)
    {
        ...
        s.ssgs_sort_2(pop_size,generation_size,crossover_rate,mutate_rate,10);
    }
    else
        std::cerr << "format command :ssgsSort file pop-size(20) generation-size(40) crossover-rate(0.1) mutate_rate(0.1)" << std::endl;
    return 0;
}